...
%	\bibliographystyle{tex/czechiso}
...
\newcommand{\zadani}{
	\clearpage
	\thispagestyle{empty}
\voffset=\valueVOffset\evensidemargin=\valueSideMargin\oddsidemargin=\valueSideMargin
\headsep=\valueHeadSep\headheight=\valueHeadHeight\setlength{\parskip}{3pt}\textheight=\valueTextHeight\textwidth=\valueTextWidth

\voffset=-3cm\headsep=0pt\headheight=0pt\topmargin=0.61cm\setlength{\parskip}{0pt}
\begin{figure*}[ht]\begin{adjustwidth}{-3.5cm}{-2cm}
\centering  
	\includegraphics[scale=1]{graphics/zadani_A.png}
\end{adjustwidth}\end{figure*}
\clearpage
\thispagestyle{empty}
\voffset=-3cm\headsep=0pt\headheight=0pt\topmargin=1.61cm\setlength{\parskip}{0pt}
\begin{figure*}[ht]\begin{adjustwidth}{-2cm}{-2cm}
\centering
	\includegraphics[scale=0.9]{graphics/zadani_B.png}
\end{adjustwidth}\end{figure*}
\clearpage
\voffset=\valueVOffset\evensidemargin=\valueSideMargin\oddsidemargin=\valueSideMargin\headsep=\valueHeadSep\headheight=\valueHeadHeight\setlength{\parskip}{3pt}\textheight=\valueTextHeight\textwidth=\valueTextWidth\topmargin=0.61cm
}
